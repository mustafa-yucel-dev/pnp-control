...
## NiDAQ6343 
The NIDAQ 6343 has the advantage of being programmable with the usual DAQ MX software that interfaces with Python. The NiDAQ6343 has an aggregate speed of 500kHz reading speed with 32 Analog input (16 being digital). This is used to read out the custom photodetector array. The PhDs are from Coheron company in France.
![NiDAQ and PhDs array](pd_array.jpg)
# PNP Control
